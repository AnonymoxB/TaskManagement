...
export const registerUser = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    // Kirim kembali user dan token dalam response ke client
    res.cookie("token", token, {
      path: "/",
      httpOnly: true,
      maxAge: 30 * 24 * 60 * 60 * 1000, // 30 hari
      sameSite: "none", // cross-site access --> izinkan semua cookie pihak ketiga
      secure: false, // sesuaikan ke true jika menggunakan HTTPS
    });
